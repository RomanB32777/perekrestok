...
const filterVacacncy = process.env.FILTER_VACANCY !== "false";

const getCitiesWithVacancies = async (citiesQuery) => {
...
class CityController {
  ...
  async getCities(req, res) {
    try {
      ...
      const cities = filterVacacncy
        ? await getCitiesWithVacancies(citiesQuery)
        : citiesQuery.rows;
